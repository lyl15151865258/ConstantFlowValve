...
public class ActivityController {
    ...
    public static void addActivity(Activity activity) {
        ...
        LogUtils.d("ActivityController", "addActivity,当前Activity栈队列中activity对象共有" + activities.size() + "个");
    }
    ...
    public static void removeActivity(Activity activity) {
        ...
        LogUtils.d("ActivityController", "removeActivity,当前Activity栈队列中activity对象共有" + activities.size() + "个");
    }
    ...
    public static void finishActivity(Activity activity) {
        ...
        LogUtils.d("ActivityController", "finishActivity,当前Activity栈队列中activity对象共有" + activities.size() + "个");
    }
    ...
    public static void exit() {
        //清除全局对象
        ConstantFlowValveApplication.getInstance().setAccount(null);
        ConstantFlowValveApplication.getInstance().setVersion(null);
        ConstantFlowValveApplication.getInstance().setVersion2(null);
        DbHelper dbHelper = ConstantFlowValveApplication.getInstance().getmDbHelper();
        if (dbHelper != null) {
            dbHelper.close();
            ConstantFlowValveApplication.getInstance().setmDbHelper(null);
        }
