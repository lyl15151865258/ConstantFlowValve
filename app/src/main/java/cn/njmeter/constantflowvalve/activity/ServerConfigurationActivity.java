...
import cn.njmeter.constantflowvalve.adapter.ServerConfigurationAdapter;
...
public class ServerConfigurationActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serverList.addAll(ConstantFlowValveApplication.getInstance().serverList);
        ...
        serverConfigurationAdapter.setOnItemClickListener((view, position) -> {
            ...
            intent.putExtra("ServerConfiguration", ConstantFlowValveApplication.getInstance().serverList.get(position));
    ...
    private TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            serverList.clear();
            for (ClientUser.Server server : ConstantFlowValveApplication.getInstance().serverList) {
