...
/**
 * 自定义分段选择控件
 * Created by Li Yuliang on 2017/11/17.
 *
 * @author LiYuliang
 * @version 2017/11/17
 */
...
public class SegmentControlView extends View {
    ...
    private static final int COLOR_PRIMARY_SELECTED = 0XFFe64a19;
    ...
    /**
     * painter of the background
     */
    private Paint paintBackground;
    /**
     * painter of the frame
     */
